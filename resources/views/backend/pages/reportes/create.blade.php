                                ...
                                <div class="card-body">
                                    <form action="" method="POST" id="reporte">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6 col-sm-12">
                                                <label for="tipo_tramite_search">Seleccione un Tipo de Trámite:</label>
                                                <select id="tipo_tramite_search" name="tipo_tramite_search" class="form-control selectpicker" data-live-search="true" multiple required>
                                                    @foreach ($tiposTramite as $key => $value)
                                                        <option value="{{ $value['id'] }}" {{ $value['nombre'] == 'NORMAL' ? 'selected' : '' }}>{{ $value['nombre'] }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6 col-sm-12">
                                                <label for="estado_tramite_id_search">Buscar por Estado Trámite:</label>
                                                <select id="estado_tramite_id_search" name="estado_tramite_id_search" class="form-control selectpicker" data-live-search="true" multiple>
                                                    <option value="">Seleccione un Estado Trámite</option>
                                                    @foreach ($estadosTramite as $key => $value)
                                                        <option value="{{ $value->id }}">{{ $value->nombre }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6 col-sm-12">
                                                <label for="fecha_devolucion_auditoria_desde_search">Buscar por Fecha Devolución Auditoría Desde</label>
                                                <div class="datepicker date input-group">
                                                    <input type="text" class="form-control" id="fecha_devolucion_auditoria_desde_search" name="fecha_devolucion_auditoria_desde_search" placeholder="">
                                                    <div class="input-group-append">
                                                    <span class="input-group-text"><i class="fa fa-calendar"></i></span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group col-md-6 col-sm-12">
                                                <label for="fecha_devolucion_auditoria_hasta_search">Buscar por Fecha Devolución Auditoría Hasta</label>
                                                <div class="datepicker date input-group">
                                                    <input type="text" class="form-control" id="fecha_devolucion_auditoria_hasta_search" name="fecha_devolucion_auditoria_hasta_search" placeholder="">
                                                    <div class="input-group-append">
                                                    <span class="input-group-text"><i class="fa fa-calendar"></i></span>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6 col-sm-12">
                                                <label for="fecha_devolucion_prestador_desde_search">Buscar por Fecha Devolución Prestador Desde</label>
                                                <div class="datepicker date input-group">
                                                    <input type="text" class="form-control" id="fecha_devolucion_prestador_desde_search" name="fecha_devolucion_prestador_desde_search" placeholder="">
                                                    <div class="input-group-append">
                                                    <span class="input-group-text"><i class="fa fa-calendar"></i></span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group col-md-6 col-sm-12">
                                                <label for="fecha_devolucion_prestador_hasta_search">Buscar por Fecha Devolución Prestador Hasta</label>
                                                <div class="datepicker date input-group">
                                                    <input type="text" class="form-control" id="fecha_devolucion_prestador_hasta_search" name="fecha_devolucion_prestador_hasta_search" placeholder="">
                                                    <div class="input-group-append">
                                                    <span class="input-group-text"><i class="fa fa-calendar"></i></span>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6 col-sm-12">
                                                <label for="observacion_devolucion_auditoria_search">Buscar por Observaciones Devolución Auditoria</label>
                                                <input type="text" class="form-control" id="observacion_devolucion_auditoria_search" name="observacion_devolucion_auditoria_search" placeholder="">
                                            </div>
                                            <div class="form-group col-md-6 col-sm-12">
                                                <label for="observacion_devolucion_prestador_search">Buscar por Observaciones Devolución Prestador</label>
                                                <input type="text" class="form-control" id="observacion_devolucion_prestador_search" name="observacion_devolucion_prestador_search" placeholder="">
                                            </div>
                                        </div>
                                        <div class="col-sm-2">
