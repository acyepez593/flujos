...
@section('title')
    {{ __('Bandeja de Remesas - Panel de Remesas') }}
@endsection
    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">{{ __('Bandeja de Remesas') }}</h4>
                <ul class="breadcrumbs pull-left">
                    <li><a href="{{ route('admin.dashboard') }}">{{ __('Dashboard') }}</a></li>
                    <li><span>{{ __('Todas las Remesas') }}</span></li>
                </ul>
            </div>
        </div>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6 col-sm-12">
                                                ...
                                                <select id="estatus_search" name="estatus_search" class="form-control selectpicker" data-live-search="true" multiple>
                                                    ...
                                                    <option value="PASO A APROBACION REMESA A LA DIRECCION DE ANALISIS DE PROTECCIONES">PASO A APROBACION REMESA A LA DIRECCION DE ANALISIS DE PROTECCIONES</option>
                                                    <option value="PASO A AUTORIZACION DE GASTO A LA DIRECCION EJECUTIVA">PASO A AUTORIZACION DE GASTO A LA DIRECCION EJECUTIVA</option>
                                                    <option value="SOLICITUD DE GASTO AUTORIZADA">SOLICITUD DE GASTO AUTORIZADA</option>
                                                    <option value="PASO DE AUTORIZACION DE GASTO A LA DIRECCION FINANCIERA">PASO DE AUTORIZACION DE GASTO A LA DIRECCION FINANCIERA</option>
                                                    <option value="EJECUCION DEL CONTROL PREVIO AUTORIZADA">EJECUCION DEL CONTROL PREVIO AUTORIZADA</option>
                                                    <option value="EN EJECUCION DEL CONTROL PREVIO">EN EJECUCION DEL CONTROL PREVIO</option>
                                                    <option value="AUTORIZADO PARA COMPROMETIDO Y DEVENGADO">AUTORIZADO PARA COMPROMETIDO Y DEVENGADO</option>
                                                    <option value="PRESUPUESTO COMPROMETIDO">PRESUPUESTO COMPROMETIDO</option>
                                                    <option value="AUTORIZADO EL ENVIO AL MEF">AUTORIZADO EL ENVIO AL MEF</option>
                                                    <option value="ENVIADO AL MEF">ENVIADO AL MEF</option>
                                                    <option value="REMESA DEVUELTA A LA DIRECCION FINANCIERA">REMESA DEVUELTA A LA DIRECCION FINANCIERA</option>
                                                    <option value="REMESA DEVUELTA A LA DIRECCION DE ANALISIS DE PROTECCIONES">REMESA DEVUELTA A LA DIRECCION DE ANALISIS DE PROTECCIONES</option>
                                                    <option value="EN CORRECCION DE REMESA DEVUELTA">EN CORRECCION DE REMESA DEVUELTA</option>
                                                </select>
                                            </div>
                                        </div>
